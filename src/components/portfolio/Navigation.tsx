  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled
          ? "bg-white/95 dark:bg-slate-900/95 backdrop-blur-sm shadow-lg border-slate-200 dark:border-slate-700"
          : "bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm border-transparent",
      )}
    >
